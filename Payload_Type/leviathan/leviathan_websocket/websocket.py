...
class Websocket(C2Profile):
    ...
    server_binary_path = pathlib.Path(".") / "leviathan_websocket" / "c2_code" / "mythic_leviathan_websocket_server"
    server_folder_path = pathlib.Path(".") / "leviathan_websocket" / "c2_code"
    parameters = [
        C2ProfileParameter(
            name="callback_host",
